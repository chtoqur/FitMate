<template>
  <div>
    <div class="card">
      <div class="img" :style="{ 'background-image': routine.img }">
        <!-- <span>이미지 들어갈 공간</span> -->
        <div
          class="save"
          :class="{ 'saved-routine': isSaved }"
      ...
      <div class="text">
        <div class="title-desc" @click="navigateToDetail(routine.id)">
...
const isSaved = computed(() => {
  return userStore.loginUser.savedRoutine.includes(props.routine.id);
});
