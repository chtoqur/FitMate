    ...
    <div class="user-info">
      ...
      <div>
        ...
        <div class="change-user-info">
          <v-btn prepend-icon="mdi-account-details" variant="outlined" size="small"
          @click="navigateToChangeInfo"
          class="change-info">
            내 정보 수정
          </v-btn>
          <v-btn prepend-icon="mdi-lock" variant="outlined" size="small"
    ...
    <div class="mylog">
      ...
      <div class="mylog-video">
        <div class="video-menu">
          ...
          @click="navigateToLikeVideo">모두 보기</v-btn>
        </div>
        <!-- 비디오 나열 -->
          ...
          <div v-for="video in videoStore.nowList" :key="video.id">
            ...
            <div class="video-title">
              ...
              <div class="video-tooltip">
                ...
                @click=unlikeMyVideo(video.id)></v-btn>
              </div>
            </div>
            <div>
              <!-- 채널이름 -->
...
onBeforeMount(async () => {
  ...
  if (userStore.loginUser.myPost.length >= 6) {
    ...
    userStore.loginUser.myPost.sort((a, b) => new Date(b.regDate) - new Date(a.regDate));
