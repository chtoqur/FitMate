                          ...
                          <v-col cols="12" sm="8">
                            ...
                            <v-row>
                              ...
                              <v-col cols="12" sm="4">
                                <v-form
                                :disabled="idChecked">
                                  <v-btn class="mt-6" tile outlined dark
                                  @click="checkId(user.id)">중복 확인</v-btn>
                                </v-form>
                              </v-col>
                            </v-row>
                            <!-- 이메일 -->
                            ...
                            <v-row>
                              ...
                              <v-col cols="12" sm="5">
                                <v-btn class="mt-2" tile outlined dark @click="postOpen">주소 찾기</v-btn>
                              </v-col>
                            </v-row>
                            <v-form disabled>
                              <v-text-field
