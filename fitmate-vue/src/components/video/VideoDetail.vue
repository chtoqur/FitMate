      ...
      <div id="card-container">
        <div id="detail-left">
          ...
          <div>
            ...
            <div id="detail-info">
              ...
              <!-- 좋아요 -->
              <div id="like-btn">
                <button :class="{ liked: isLiked }" @click="toggleLike" class="button-like">
        ...
        <div id="detail-right">
          ...
          <div class="register-box input-group">
            <div class="register-comment">
              ...
              <textarea
                ...
                rows="3" aria-label="With textarea"
                v-model="review"
              ></textarea>
          ...
          <div class="comment-list-container">
            <div id="comment-list">
              <span>영상 댓글
                <span class="comment-count">{{ store.videoReviewList.length }}</span>
              </span>
            </div>
            <hr>
            <div>
