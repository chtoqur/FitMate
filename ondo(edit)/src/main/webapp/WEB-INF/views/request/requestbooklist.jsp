...
<link href="../css/requestbooklist.css" rel="stylesheet">
                ...
                <tr>
                    <td>
                        ...
                        <div id="list-body">
                            ...
                            <div>
                                <a href="/request/requestbook?isbn=${book.isbn}&title=${book.title}&author=${book.author}&publisher=${book.publisher}&pubdate=${book.pubdate}&discount=${book.discount}" id="btnRequest">희망도서신청</a>
                            </div>
                        </div>
                    </td>
                </tr>
...
(()=>{  
    ...
    btnSearch.addEventListener('click', ()=>{
        ...
        location.href = "/request/requestbooklist" + queryString;
    });
